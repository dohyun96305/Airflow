...
with DAG(dag_id = "triggerdagop_target_dag", 
         ...
         schedule_interval = None) as dag: # Because schedule_interval sets to None => Need to Execute Controller DAG first
    ...
    t2 = BashOperator( 
        ...
        # Using templates with predefined object dag_run

    t3 = BashOperator(
        task_id = "t3",
        bash_command = "sleep 30"
        # While Target DAG is not finished, Controller DAG will be finished => Independent
    )