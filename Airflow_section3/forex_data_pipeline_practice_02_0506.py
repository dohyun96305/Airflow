...
with DAG('forex_data_pipeline',                     # unique dag id
    ...
    Check_forex_rates_available  = HttpSensor(                          # HttpSensor : to check API (URL) with certain condition
        ...
        http_conn_id = 'forex_api',                                     # id of the connection 
    ...
    # Go to Airflow UI to connect HttpSensor

    # Admin - Connections - Add New Connection to add HttpSensor conn
    # Conn id => http_conn_id
    # Conn type => HttpSensor : http
    ### Host => host where url have
