# 07 => Add SparkOperator => put data to Hive Table
...
with DAG('forex_data_pipeline',                     # unique dag id
    ...
    Processing_forex_data = SparkSubmitOperator(                        # SparkSubmitOperator : to interact with Spark  
    ...
    # Go to Airflow UI to connect SparkSubmitOperator

    # Admin - Connections - Add New Connection to add SparkSubmitOperator Conn
    # Conn id => conn_id
    # Conn type => Spark
    # host (spark://spark-master) => name of the Spark host
    #  Port 
